...
<template>
  <div class="venia-card" role="dialog" aria-label="Cookie consent">
    ...
    <div v-if="customizeVisible" class="venia-customize venia-customize--compact">
      <ConsentCategoryList
    ...
    <div class="venia-actions">
      ...
      <button class="venia-btn venia-btn--ghost" @click="toggleCustomize">
